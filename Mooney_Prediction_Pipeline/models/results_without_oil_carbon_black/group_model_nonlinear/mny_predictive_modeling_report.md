# Two-Stage Non-Linear Group Predictive Modeling Report - Without-Oil Carbon-Black

This model uses a Two-Stage Non-Linear architecture with LightGBM in Stage 2 to decouple recipe baselines and capture complex process variations.

## 5-Fold Group CV Performance
- **R^2**: 0.9518
- **MAE**: 3.1192 MU
- **RMSE**: 4.0298 MU
- **Within-Compound Deviation Correlation**: -0.3941
- **Pred/Actual Std Ratio**: 0.9971
